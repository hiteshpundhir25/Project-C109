...
#Calc the mean and the standard deviation
...
#Plotting the chart and lines for mean
...
print("Meadian of this data is {}".format(meadian))
print("Mode of this data is {}".format(mode))
print("Standard deviation of this data {}".format(std_deviation))
